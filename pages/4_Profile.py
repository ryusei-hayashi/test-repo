...
st.header('Developer')
profile('Ryusei Hayashi', 'Nihon University, Graduate School of Integrated Basic Sciences, Major of Earth Information Mathematical Sciences, Kitahara Lab', 'Student', '')
